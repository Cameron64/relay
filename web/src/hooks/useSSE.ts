...
// reconnect AFTER the first open, it backfills any cards missed while disconnected (since cursor).
// EventSource auto-reconnects on error, so there's nothing to do on error but let it.
